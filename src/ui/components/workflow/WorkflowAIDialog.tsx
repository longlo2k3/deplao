...
5. Dùng biến template: {{ $trigger.content }}, {{ $trigger.threadId }}, {{ $trigger.fromId }}, {{ $trigger.fromName }}, {{ $trigger.threadType }}, {{ $trigger.body }} (dữ liệu webhook), {{ $trigger.body.<field> }} (VD: $trigger.body.uid, $trigger.body.message), {{ $trigger.method }}, {{ $trigger.headers }}, {{ $prev.result }}, {{ $vars.<tên biến> }}.
