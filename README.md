...
<img src="https://deplaoapp.com/assets/icon-CuJ0M91u.png" alt="Deplao Logo" width="120" />
...
<p align="center">
  <img src="./assets/deplao-overview-map.svg" alt="Deplao Overview Map - Sơ đồ tổng quan trung tâm vận hành Deplao" width="100%" />
</p>
...
<table width="100%">
  <tr>
    <td align="center" width="33%">
      <img src="./assets/dashboard.png" alt="Dashboard quản lý đa tài khoản" width="100%" /><br/>
      <sub><b>1. Dashboard đa tài khoản</b></sub>
    </td>
    <td align="center" width="33%">
      <img src="./assets/chat.png" alt="Giao diện chat tập trung" width="100%" /><br/>
      <sub><b>2. Chat tập trung & Trợ lý AI</b></sub>
    </td>
    <td align="center" width="33%">
      <img src="./assets/crm.png" alt="Màn hình CRM quản lý liên hệ" width="100%" /><br/>
      <sub><b>3. CRM & Quản lý nhãn liên hệ</b></sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="33%">
      <img src="./assets/scan-members-group.png" alt="Quét thành viên nhóm Zalo" width="100%" /><br/>
      <sub><b>4. Quét thành viên nhóm ẩn</b></sub>
    </td>
    <td align="center" width="33%">
      <img src="./assets/campaign.png" alt="Chiến dịch gửi tin hàng loạt" width="100%" /><br/>
      <sub><b>5. Chiến dịch CSKH hàng loạt</b></sub>
    </td>
    <td align="center" width="33%">
      <img src="./assets/workflow.png" alt="Trình thiết kế Workflow kéo thả" width="100%" /><br/>
      <sub><b>6. Workflow Editor kéo-thả</b></sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="33%">
      <img src="./assets/detail-workflow.png" alt="Chi tiết cấu hình Workflow" width="100%" /><br/>
      <sub><b>7. Cấu hình chi tiết Node</b></sub>
    </td>
    <td align="center" width="33%">
      <img src="./assets/workflow-ai.png" alt="Tạo Workflow bằng lệnh AI" width="100%" /><br/>
      <sub><b>8. Tạo Workflow bằng AI Prompt</b></sub>
    </td>
    <td align="center" width="33%">
      <img src="./assets/pos.png" alt="Tích hợp POS và bán hàng" width="100%" /><br/>
      <sub><b>9. Tích hợp POS & Bán hàng</b></sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="33%">
      <img src="./assets/report.jpg" alt="Báo cáo & Phân tích tổng quan" width="100%" /><br/>
      <sub><b>10. Báo cáo & Phân tích tổng quan</b></sub>
    </td>
    <td align="center" width="33%">
      <img src="./assets/report-employee.png" alt="Báo cáo hiệu suất nhân viên" width="100%" /><br/>
      <sub><b>11. Phân tích năng suất Nhân viên</b></sub>
    </td>
    <td align="center" width="33%">
      <img src="./assets/erp.png" alt="ERP nội bộ & Quản lý công việc" width="100%" /><br/>
...
flowchart LR
    ...
    subgraph COMPILE["🔨 Compile Process"]
        TSC("tsc\ntsconfig.electron")
        VITE("vite build\n+ Tailwind CSS")
    end

    subgraph OUT["📦 Distribution Build"]
        DE("dist-electron/\nmain · services · ipc")
        D("dist/\nindex.html · assets")
    end

    subgraph PKG["🚀 Đóng gói App"]
        EB(("electron\nbuilder"))
        WIN("🪟 Windows\n.exe / installer")
        MAC("🍎 macOS\n.dmg arm64 / x64")
        LIN("🐧 Linux\n.AppImage · .deb")
  ...
  root((🖥️ Deplao Core System))
    ...
    🎨 Renderer Process
      ⚛️ React Pages & Views
        ...
        POS & Shipping Integration
        ERP Tasks · Reports
      🗃️ Zustand Stores
        accountStore · chatStore
        workspaceStore · employeeStore
    📱 Giao thức Kết nối
      zca-js & fbchat-v2
        QR Code Login
    ...
    🌐 External APIs
      OpenAI · Claude · Gemini · 9Router
      Google Sheets · Telegram · Discord
      KiotViet · Haravan · Sapo · GHN · GHTK
```
...
```mermaid
flowchart TB
    subgraph BOSS["🖥️ MÁY BOSS (Master Workspace)"]
        BZ("📱 Zalo / FB / Telegram Accounts")
        BSV("🔧 Deplao Services\nCRM · ERP · AI · Workflow Engine")
        BSD[("🗄️ SQLite Database\n+ Local Media Assets")]
        BRL("🔁 Relay Server Engine\nHTTP REST + Socket.IO Server :9900")
        BRS("📡 REST API Router\n/api/query | /api/command\n/api/library | /api/media")
    end

    subgraph NET["🌐 MẠNG KẾT NỐI"]
        LAN("🏠 Mạng Nội Bộ LAN\n192.168.x.x:9900")
        WAN("🌍 Tunnel / Cloud VPN\nTruy cập từ xa từ internet")
    end

    subgraph EMP["💻 MÁY NHÂN VIÊN (Remote Client Workspace)"]
        EA("📲 Deplao App (Employee Mode)")
        DA("🔀 DataAccessor Router\nTự động chuyển luồng")
        RQ("🌐 RestQueryClient\nHTTP Client Service")
        EP("🔐 Permission Gatekeeper\nLọc quyền Module & Tài khoản")
        EU("👁️ Dashboard UI\nChỉ hiển thị dữ liệu được cấp quyền")
        MC("📦 Local Media Cache")
        EC("⚡ Client Memory Cache\nTin nhắn & Hội thoại")
    end
    ...
    RQ -->|/api/media| MC
    RQ -->|/api/library| BSV
    EA --> DA -->|Boss Mode → Direct IPC| EU
    DA -->|Employee Mode → REST| RQ
    EA --> EP --> EU
    EA --> EC
    EA --> MC
```
